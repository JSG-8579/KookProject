...
function MypageButton({ idxdata, session, dataCrl, dataCrl4,dataCrl5 }: any) {
    ...
    return (
        <div className='my_btn'>
            ...
            <button onClick={() => {idxdata('좋아요 레시피'); dataCrl5('all', '', '') }}><img src='/images/heart_black.png' />Like</button>
